...
export default forwardRef<VideoPlayerRef, VideoPlayerProps>(function VideoPlayer(
  { videoUrl, onTimeUpdate, onEnd },
  ref,
) {
  ...
  if (!Hls.isSupported()) {
    return (
      <div>
        ...
        <p>
          HLS is not supported in this browser. Please try a different browser to view this content.
        </p>
      </div>
    );
  }
